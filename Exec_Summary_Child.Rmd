...
knitr::kable(stns_param_summary_tbl[,c(1:4,11:16)],
             ...
             caption = tbls(name = "exec_parmSumTable2", 
                            caption = paste0("Continued summary of monitoring stations status and trend, where 'Exceeds' represents a single exceedance of the water quality standard or TMDL target within the last two whole years. See ", tbls("exec_parmSumTable1", cite = ), " Note: DO = dissolved oxygen, TP = total phosphorus, TSS = total suspended solids.")))
