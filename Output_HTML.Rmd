...
title: '<img src="LogoColorRegular.jpg" style="float: right;width: 80px; "/> Oregon
  DEQ Water Quality Status and Trends report for the Walla Walla AgWQ Management Area'
author: ''
date: "October 2017"
output:
  html_document:
...
input$select <- "Walla Walla" #input
input$dates <- c("2000-01-01", "2017-10-01") #input
