...
title: '<img src="LogoColorRegular.jpg" style="float: right;width: 80px; "/> Oregon
  DEQ Water Quality Status and Trends report for the Tualatin River Subbasin AgWQ
  Management Area'
author: ''
date: "October 2017"
output:
...
#df.all_backup <- df.all

# test <- df.all %>% 
#   filter(grepl('Dairy | Mckay', Station_Description, ignore.case = TRUE))
...
#- Summary 
![](T:/AgWQM/DataAnalysis/Greater Harney Basin/Figures/WQassessment_Harney12122017.png)
