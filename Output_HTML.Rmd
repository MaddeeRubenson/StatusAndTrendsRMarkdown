...
title: '<img src="LogoColorRegular.jpg" style="float: right;width: 80px; "/> Oregon
  DEQ Water Quality Status and Trends report for the Crooked River AgWQ
  Management Area'
author: ''
date: "January 2018"
output:
...
input$select <- "Crooked River" #input
...
kable(landuse, digits = 0, format = "markdown", padding = 2, caption = "Summary table of watershed land use by station, only stations which have at least 8 years of yearly data (between 2000 and 2017) and/or are used to evaluate last known status. ")
```
...
```
##E.coli
```{r Ecoli, echo = FALSE, message = FALSE, warning=FALSE, error = TRUE, fig.width = 7, fig.height = 7, fig.cap = '_E. Coli_ water quality status and trends'}
...
##Total Phosphorus
```{r Total Phosphorus, echo = FALSE, message = FALSE, warning=FALSE, error = TRUE, fig.width = 7, fig.height = 7, fig.cap = 'Total phosphorus water quality status and trends'}
source("functions/funPlots.R")
...
```{r TSS, echo = FALSE, message = FALSE, warning=FALSE, error = TRUE, fig.width = 7, fig.height = 7, fig.cap = 'Total Suspended Solids water quality status and trends'}
source("functions/funPlots.R")
library(dplyr)
library(ggplot2)
library(knitr)
...
##pH
```{r pH, echo = FALSE, message = FALSE, warning=FALSE, error = TRUE, fig.width = 7, fig.height = 7, fig.cap = 'pH water quality status and trends'}
source("functions/funPlots.R")
library(dplyr)
library(ggplot2)
library(knitr)
...
##Temperature
```{r Temperature, echo = FALSE, message = FALSE, warning=FALSE, error = TRUE, fig.width = 7, fig.height = 7, fig.cap = 'Temperature water quality status and trends'}
source("functions/funPlots.R")
library(dplyr)
library(ggplot2)
library(knitr)
...
##Dissolved Oxygen
```{r Dissolved Oxygen, echo = FALSE, message = FALSE, warning=FALSE, error = TRUE, fig.width = 7, fig.height = 7, fig.cap = 'Dissolved Oxygen water quality status and trends'}
source("functions/funPlots.R")
library(dplyr)
library(ggplot2)
library(knitr)
...
#- Summary 
![](T:/AgWQM/DataAnalysis/Crooked River/Figures/WQassessment_CrookedRiver_03122018.png)
...
#write.csv(stnsformap, "T:/AgWQM/DataAnalysis/Powder-Brownlee/Data/parm_summary_stns-11092017.csv")
