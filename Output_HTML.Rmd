...
title: '<img src="LogoColorRegular.jpg" style="float: right;width: 80px; "/> Oregon
  DEQ Water Quality Status and Trends report for the Greater Harney Basin AgWQ Management
  Area'
author: ''
date: "November 2017"
output:
...
input$select <- "Tualatin River Subbasin" #input
input$dates <- c("2000-01-01", "2017-11-01") #input
...
# deq <- query(select =  input$select,
#               parms = input$parms,
#               dates = input$dates,
#               db = input$db)
# 
# df.all <- rbind.fill(wqp, deq)
