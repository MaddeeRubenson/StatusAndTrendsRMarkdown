...
title: '<img src="LogoColorRegular.jpg" style="float: right;width: 80px; "/> Oregon
  DEQ Water Quality Status and Trends report for the Middle Willamette AgWQ
  Management Area'
author: ''
date: "December 2017"
output:
...
input$select <- "Middle Willamette" #input
input$dates <- c("2000-01-01", "2018-01-01") #input
...
if(length(tp_stn) > 0) {
  ...
  #} else {
    ...
    for(j in 1: length(tp_stn)) {
      ...
      if(input$select == 'Powder-Brownlee') { #Snake River Hells Canyon TMDL allocation 2004
...
#- Summary 
![](T:/AgWQM/DataAnalysis/Middle Deschutes/Figures/WQassessment_MiddleDeschutes_01182018.png)
