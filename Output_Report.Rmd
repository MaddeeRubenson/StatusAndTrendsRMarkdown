...
fit_criteria$Analyte <- gsub("[Ee]. [cC]oli", "_E. coli_", fit_criteria$Analyte)
fit_criteria$Analyte <- gsub("[Ee]terococcus", "_Enterococcus_", fit_criteria$Analyte)
