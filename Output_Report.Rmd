...
project_dir <-  "//deqhq1/WQNPS/Agriculture/Status_and_Trend_Analysis/SIAs/2019-SIA-Thirtymile"
...
# import GIS features
# SIA area shp
sia_shp <- readOGR(dsn = GIS_dir, layer = 'Thirtymile_SIA', integer64="warn.loss", verbose = FALSE)
...
BC_table<-data.frame('Walker Stout', deq, oda)
