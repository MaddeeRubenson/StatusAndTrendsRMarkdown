...
```{r stations-map-word, fig.cap=figs(name="stationsmap", caption="Monitoring station locations within the Umpqua River AgWQ Management Area**")}
...
```{r landuse-map-word, fig.cap=figs(name="landusemap", caption="Land use and land cover within the Umpqua River AgWQ Management Area**")}
