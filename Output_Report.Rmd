...
tbls(name="place1", caption="", display = FALSE)
tbls(name="place2", caption="", display = FALSE)
tbls(name="place3", caption="", display = FALSE)
...
```{r Ecoli, echo = FALSE, results = 'asis', fig.width = 6, fig.height = 6}
...
```{r Entero, fig.height=6, fig.width=6, results='asis'}
source("functions/funPlots.R")
library(dplyr)
library(ggplot2)
library(knitr)
