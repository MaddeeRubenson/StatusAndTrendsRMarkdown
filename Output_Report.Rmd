  ...
  for(j in 1: length(tp_stn)) {
    ...
    if (input$select %in% c('Owyhee','Malheur River','Burnt River','Powder-Brownlee','Hells Canyon','Lower Snake Asotin')) {
      ...
      TP_evaluate <- EvaluateTP_SRHC(new_data, 
                                     selectWQSTP = 0.07)
    } else if (df.tp$Station_ID %in% c('WR4000', 'WR5000', 'KL0010', '422820122032100', '422622122004000', '422719121571400', '422305121553800','422042121513100', '421401121480900')) {            
      TP_evaluate <- EvaluateTP_UKL_lake(new_data,
                                         annual_target=0.11, 
                                         spring_target=0.03)
      } else if (df.tp$Station_ID %in% c('10770', '11501000', '11502500', '21535', '422305121553803', '422622122004003', 'FWNF-085', 'FWNF-129','FWNF-130', 'FWNF-161', 'SR0040', 'SR0050', 'SR0060', 'SR0070', 'SR0080', 'SR0090', 'SR0140', 'WR1000', 'WR2000', 'WR3000', 'WR6000')) {
