...
*	Are the Snake River - Hells Canyon sediment and nutrients TMDL targets for total phosphorus and total suspended solids being achieved?
...
Within the `r input$select` Agriculture Water Quality Management Area, data from `r length(unique(stns$Station_ID))` monitoring stations were sufficient to assess status and/or trends out of `r length(unique(df.all$Station_ID))` total monitoring stations. 
...
```{r stations-map-word, eval = word_output, results = "asis", fig.cap=figs(name="stationsmap", caption=paste0("Monitoring station locations within the ", agwqma, " Agriculture Water Quality Management Area."))}
...
```{r landuse-map-word, eval = word_output, results = "asis", fig.cap=figs(name="landusemap", caption=paste0("Land use and land cover within the ", agwqma, " Agriculture Water Quality Management Area."))}
...
```{r landuse-map-html, results= 'asis', eval = !(word_output), fig.width=8, fig.height=8, fig.cap=figs(name="landusemap", caption="Land use and land cover within the Umpqua River Agriculture Water Quality Management Area.")}
