---
title: '<img src="Figures/LogoColorRegular.jpg" style="float: right;width: 80px; "/>Walker Stout Strategic Implementation Area Water Quality Status and Trends Report'
...
project_dir <-  "//deqhq1/WQNPS/Agriculture/Status_and_Trend_Analysis/SIAs/2019-SIA-Upper-Muddy"
...
# import GIS features
# SIA area shp
sia_shp <- readOGR(dsn = GIS_dir, layer = 'UpperMuddy_SIA', integer64="warn.loss", verbose = FALSE)
...
deq<- paste('Nancy Gramlich','gramlich.nancy@deq.state.or.us', sep = '; ')

oda<- paste('Jo Morgan', 'jmorgan@oda.state.or.us', sep = '; ')

BC_table<-data.frame('Upper Muddy', deq, oda)
