...
# import GIS features
# SIA area shp
sia_shp <- readOGR(dsn = GIS_dir, layer = 'WalkerStout_SIA', integer64="warn.loss", verbose = FALSE)
...
```{r landuse-map-word, eval = word_output, results = "asis", fig.cap=figs(name="landusemap", caption=paste0("Land use and land cover within the ", sia, " Agricultural Water Quality Management Area."))}
...
```{r landuse-map-html, results= 'asis', eval = !(word_output), fig.width=8.5, fig.height=7, fig.cap=figs(name="landusemap", caption=paste0("Land use and land cover within the ", sia, " Agricultural Water Quality Management Area."))}
...
sia_shp_buff <- gBuffer(sia_shp, width=500)
