...
if(length(entero_stns) > 0) {
  ...
  print(paste0("A status and trend assessment was not made for_Enterococcus_ because the marine water contact recreation use criteria do not apply in the ",agwqma,".")) 
} 
  ...
  for(j in 1: length(tp_stn)) {
    ...
    cat(figs(name = paste0('TP_', tp_stn[j]), 
             caption = paste0('Station ', tp_stn[j], 
                              ' TTotal Phosphorus water quality status and/or trends.')))
