...
# Set to TRUE if wanting to use AWQMS Query
Query_AWQMS <- TRUE
...
```{r AWQMS-Query, include=FALSE, eval=Query_AWQMS}
...
if(file.exists(file=paste0(Rdata_dir,"/",df_all_raw_file))) {
  ...
  # NWIS_Data <- tryCatch(nwisQuery(planArea = agwqma,
  #                                 HUClist = HUClist,
  #                                 inParms = input$parms,
...
```{r Query, include=FALSE, eval=!Query_AWQMS}
