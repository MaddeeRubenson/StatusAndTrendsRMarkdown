...
```{r stations-map-word, eval = word_output, results = "asis", eval= fig.cap=figs(name="stationsmap", caption="Monitoring station locations within the Umpqua River AgWQ Management Area**")}

knitr::include_graphics(path = "Figures/Umpqua_River_station_map.png")
...
knitr::include_graphics(path = "Figures/Umpqua_River_landuse_map.png")
...
```{r Ecoli-summary-map, eval = word_output, results='asis', fig.cap=figs(name="Ecoli_map", caption="Summary of stations that fit the criteria for status and trend analysis for E coli. One or more exceedances within the last three years of available data defined whether a station was Meeting or Not Meeting. Trend was determined by significant trends associated with long-term datasets. Clusters of stations (grey circles located on the western margin of the study area) had insufficient data to determine status and trends for E. coli.**")}
...
```{r Temp-summary-map, eval = word_output, results='asis', fig.cap=figs(name="Temperature_map", caption="Summary of stations that fit the criteria for status and trend analysis for temperature. One or more exceedances within the last three years of available data defined whether a station was Meeting or Not Meeting. Trend was determined by significant trends associated with long-term datasets.**")}
