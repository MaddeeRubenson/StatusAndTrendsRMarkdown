...
```{r landuse-map-word, eval = word_output, fig.cap=figs(name="landusemap", caption="Land use and land cover for the upstream catchments of stations used in this analysis; source: 2011 NLCD**")}
...
knitr::kable(stns_by_year,  padding = 1, digits = 1, caption = tbls(name = "AppendixstnByYrTable", caption = "All monitoring stations that were queried and the number of results per year from 2000 to 2018**"))
