---
title: '<img src="Figures/LogoColorRegular.jpg" style="float: right;width: 80px; "/>Lower Deschutes Agricultural Water Quality Management Area Water Quality Status and Trends Report'
...
agwqma <- "Lower Deschutes"
query_dates <- c("2000-01-01", "2018-07-01")
project_dir <- "//deqhq1/WQNPS/Agriculture/Status_and_Trend_Analysis/Lower Deschutes/2018-Lower-Deschutes"
  ...
  if(length(DO_stn) > 0) {
    ...
    if(any(!is.na(in_bentable))) {
      ...
      for(j in 1: length(DO_stn)) {
        ...
        DO_Benuse <- (Ben_use_LU[Ben_use_LU$Station_ID == DO_stn[j] & Ben_use_LU$AgArea == agwqma, 'DO_use'])
