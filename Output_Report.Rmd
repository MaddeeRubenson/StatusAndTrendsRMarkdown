---
title: '<img src="Figures/LogoColorRegular.jpg" style="float: right;width: 80px; "/>Coos-Coquille Agricultural Water Quality Management Area Water Quality Status and Trends Report'
...
agwqma <- "Coos-Coquille"
query_dates <- c("2000-01-01", "2018-06-01")
project_dir <- "//deqhq1/WQNPS/Agriculture/Status_and_Trend_Analysis/Coos-Coquille/2018-Coos-Coquille-Revision"
...
```{r landuse-map-html, results= 'asis', eval = !(word_output), fig.width=8, fig.height=8, fig.cap=figs(name="landusemap", ccaption=paste0("Land use and land cover within the ", agwqma, " Agricultural Water Quality Management Area."))}
