...
Two stations located on the Umatilla River at Yoakum Bridge (Station IDs 10404 and CTUIR_WQX-9) are within 60 meters from each other. Because of the close distance the available data for these two stations were combined. Station ID 10404: Umatilla River at Yoakum Bridge was used in this report to identify the combined data and results.
...
Results for pH from both grab and continuous sample data were compared to the applicable water quality criterion as found in [OAR 340-041-0021][2.2.1] and the basin specific rules found in [OAR 340-041-0315][2.2.2].

Results for bacteria samples were compared to the applicable bacteria criterion as found in [OAR 340-041-0009][2.2.3]. The bacteria standard for freshwater contact recreation is based on the presence of *E. coli* compared to a single sample maximum and a geometric mean of five or more samples in a 90 day period. A status and trend assessment was not made for the _Enterococcus_ or fecal coliform indicators because the marine water contact recreation and shellfish harvesting use criteria do not apply in the Umatilla Basin.

Dissolved oxygen status was assessed by comparing the observed concentration values to the applicable daily minimum cold-water, cool-water, or spawning aquatic life use criterion found in [OAR 340-041-0016][2.2.4]. The fish use designations mapped in [OAR 340-041-0016 Figure 310A][2.2.5] and the salmon and steelhead spawning use designations mapped in [OAR 340-041-0016 Figure 310B][2.2.6] inform which dissolved oxygen aquatic life use apply. If the dissolved oxygen concentration exceeded the water quality criterion, but met the criteria for percent saturation at the same time, it was considered to be in compliance with the water quality criterion. These points were noted in the plots using a different shape. Assessments were not made against the seven and 30-day mean minimum dissolved oxygen criteria due to the general lack of continuous dissolved oxygen data.

Results for continuous temperature data were compared against the applicable temperature criteria found in [OAR 340-041-0028][2.2.7]. The fish use designations mapped in [OAR 340-041-0016 Figure 310A][2.2.5] and the salmon and steelhead spawning use designations mapped in [OAR 340-041-0016 Figure 310B][2.2.6] specify where the applicable temperature criteria apply and at what times salmon and steelhead and spawning is a designated use. The temperature criteria is based on the seven day average daily maximum (7DADM) stream temperature metric. In order to ensure there was sufficient continuous data to calculate 7DADM, at least one observation per hour from noon to midnight must have been recorded. In addition, each month can have no more than one day of missing observations to ensure that no more than 10% of the 7DADM results in that month were missing.

Results for total suspended solids were compared against the instream TSS concentration loading capacity targets established in the [Umatilla Basin Sediment TMDL][2.2.8]. The loading capacity targets range from 60-110 mg/L depending on location.
...
[2.2.2]: https://secure.sos.state.or.us/oard/viewSingleRule.action;JSESSIONID_OARD=kXxU6Bd8vPKFxF8omzLR9w4fSQQ1Fkv2NNyRYIdwJyJpjN3KNpXj!-609023700?ruleVrsnRsn=68934
[2.2.3]: https://secure.sos.state.or.us/oard/viewSingleRule.action;JSESSIONID_OARD=Q--AbU9sI2gNpiU9aa_3IO93qbFAoGOHlZ2WHGSe8IsE0OGtWMuS!568786841?ruleVrsnRsn=68695
[2.2.4]: https://secure.sos.state.or.us/oard/viewSingleRule.action;JSESSIONID_OARD=Q--AbU9sI2gNpiU9aa_3IO93qbFAoGOHlZ2WHGSe8IsE0OGtWMuS!568786841?ruleVrsnRsn=68706
[2.2.5]: https://www.oregon.gov/deq/Rulemaking%20Docs/figure310a.pdf
[2.2.6]: https://www.oregon.gov/deq/Rulemaking%20Docs/figure310b.pdf
[2.2.7]: https://secure.sos.state.or.us/oard/viewSingleRule.action;JSESSIONID_OARD=Q--AbU9sI2gNpiU9aa_3IO93qbFAoGOHlZ2WHGSe8IsE0OGtWMuS!568786841?ruleVrsnRsn=244176
[2.2.8]: https://www.oregon.gov/deq/wq/tmdls/Pages/TMDLs-Umatilla-Basin.aspx
...
# format for table
stns_param_summary_tbl <- dplyr::select(stns_param_summary, -c(DECIMAL_LAT,DECIMAL_LONG, Entero_S, Entero_T, TP_S))
...
knitr::kable(stns_param_summary_tbl, 
             ...
             caption = tbls(name = "parmSumTable", 
                            caption = "Summary of monitoring stations status and trend, where 'Exceeds' represents a single exceedance of the water quality standard or TMDL target within the last two whole years. Note: DO = dissolved oxygen, TSS = total suspended solids."))
